...
public class CarSystemBarController {
    ...
    private final boolean mShowBottom2;
    ...
    private CarSystemBarView mBottom2View;
    ...
    public CarSystemBarController(Context context,
        ...
        mShowBottom2 = systemBarConfigs.getEnabledStatusBySide(SystemBarConfigs.BOTTOM2);
    ...
    public ViewGroup getSecondaryBottomWindow(Context context) {
        return mShowBottom2 ? mCarSystemBarViewFactory.getSecondaryBottomWindow(context) : null;
    }
    ...
    /** Toggles the bottom nav bar visibility. */
    public boolean setSecondaryBottomWindowVisibility(Context context, @View.Visibility int visibility) {
        return setWindowVisibility(getSecondaryBottomWindow(context), visibility);
    }
    ...
    public CarSystemBarView getSecondaryBottomBar(Context context, boolean isSetUp) {
        Log.d(TAG, "getSecondaryBottomBar(): context=" + context + " ; isSetUp=" + isSetUp);
        if (!mShowBottom2) {
            return null;
        }

        mBottom2View = mCarSystemBarViewFactory.getSecondaryBottomBar(context, isSetUp);
        setupBar(mBottom2View, mBottomBarTouchListener, mNotificationsShadeController,
                mHvacPanelController, mHvacPanelOverlayViewController);
        return mBottom2View;
    }
