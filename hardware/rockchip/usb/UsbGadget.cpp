...
#define LOG_TAG "android.hardware.usb.gadget@1.1-service.rockchip"
  ...
  switch (functions) {
    case static_cast<uint64_t>(GadgetFunction::MTP):
      if (vendorFunctions == "diag") {
        ...
        ret = setVidPid(VENDOR_ID_ROCKCHIP, "0x0007");
      }
      break;
    case GadgetFunction::ADB | GadgetFunction::MTP:
      if (vendorFunctions == "diag") {
        ...
        if (!(vendorFunctions == "user" || vendorFunctions == ""))
          ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
        ret = setVidPid(VENDOR_ID_ROCKCHIP, "0x0017");
      }
      break;
    case static_cast<uint64_t>(GadgetFunction::RNDIS):
      if (vendorFunctions == "diag") {
        ...
        if (!(vendorFunctions == "user" || vendorFunctions == ""))
          ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
        ret = setVidPid(VENDOR_ID_ROCKCHIP, "0x0003");
      }
      break;
    case GadgetFunction::ADB | GadgetFunction::RNDIS:
      if (vendorFunctions == "diag") {
        ...
        if (!(vendorFunctions == "user" || vendorFunctions == ""))
          ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
        ret = setVidPid(VENDOR_ID_ROCKCHIP, "0x0013");
      }
      break;
    case static_cast<uint64_t>(GadgetFunction::PTP):
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_ROCKCHIP, "0x0008");
      break;
    case GadgetFunction::ADB | GadgetFunction::PTP:
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_ROCKCHIP, "0x0018");
      break;
    case static_cast<uint64_t>(GadgetFunction::ADB):
      if (vendorFunctions == "diag") {
        ...
        if (!(vendorFunctions == "user" || vendorFunctions == ""))
          ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
        ret = setVidPid(VENDOR_ID_ROCKCHIP, "0x0006");
      }
      break;
    case static_cast<uint64_t>(GadgetFunction::MIDI):
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_ROCKCHIP, "0x0004");
      break;
    case GadgetFunction::ADB | GadgetFunction::MIDI:
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_ROCKCHIP, "0x0014");
      break;
    case static_cast<uint64_t>(GadgetFunction::ACCESSORY):
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_GOOGLE, "0x2d00");
      break;
    case GadgetFunction::ADB | GadgetFunction::ACCESSORY:
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_GOOGLE, "0x2d01");
      break;
    case static_cast<uint64_t>(GadgetFunction::AUDIO_SOURCE):
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_GOOGLE, "0x2d02");
      break;
    case GadgetFunction::ADB | GadgetFunction::AUDIO_SOURCE:
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_GOOGLE, "0x2d03");
      break;
    case GadgetFunction::ACCESSORY | GadgetFunction::AUDIO_SOURCE:
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_GOOGLE, "0x2d04");
      break;
    case GadgetFunction::ADB | GadgetFunction::ACCESSORY |
         GadgetFunction::AUDIO_SOURCE:
      if (!(vendorFunctions == "user" || vendorFunctions == ""))
        ALOGE("Invalid vendorFunctions set: %s", vendorFunctions.c_str());
      ret = setVidPid(VENDOR_ID_GOOGLE, "0x2d05");
      break;
    default:
