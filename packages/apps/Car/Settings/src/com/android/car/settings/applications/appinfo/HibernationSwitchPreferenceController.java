...
public final class HibernationSwitchPreferenceController
    ...
    public void setPackageName(String packageName) {
        ...
        try {
            mPackageUid = packageManager.getPackageUidAsUser(packageName, /* flags= */ 0,
                    mUserId > 0 ? mUserId : UserHandle.myUserId());
    ...
    public HibernationSwitchPreferenceController setUserId(int userId) {
        this.mUserId = userId;
        return this;
    }
