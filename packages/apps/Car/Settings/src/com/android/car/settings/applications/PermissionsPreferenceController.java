...
public class PermissionsPreferenceController extends PreferenceController<Preference> {
    ...
    protected boolean handlePreferenceClicked(Preference preference) {
        ...
        if (mAppEntry != null) {
            intent.putExtra(Intent.EXTRA_USER, UserHandle.getUserHandleForUid(mAppEntry.info.uid));
        }
        try {
    ...
    public PermissionsPreferenceController setAppEntry(ApplicationsState.AppEntry appEntry) {
        mAppEntry = appEntry;
        return this;
    }
