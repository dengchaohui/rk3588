...
public class SystemBarConfigs {
    ...
    @IntDef(value = {TOP, BOTTOM, LEFT, RIGHT, BOTTOM2})
    ...
    private boolean mBottom2NavBarEnabled;
    ...
    private static void populateMaps() {
        ...
        BAR_GRAVITY_MAP.put(BOTTOM2, Gravity.BOTTOM);
        ...
        BAR_TITLE_MAP.put(BOTTOM2, "SecondaryBottomCarSystemBar");
        ...
        BAR_GESTURE_MAP.put(BOTTOM2, InsetsState.ITYPE_BOTTOM_MANDATORY_GESTURES);
    }
    ...
    private void readConfigs() {
        ...
        mBottom2NavBarEnabled = mResources.getBoolean(R.bool.config_enableBottom2SystemBar);
        ...
        if (mBottom2NavBarEnabled) {
            SystemBarConfig bottom2BarConfig =
                    new SystemBarConfigBuilder()
                            .setSide(BOTTOM2)
                            .setGirth(mResources.getDimensionPixelSize(
                                    R.dimen.car_bottom_system_bar_height))
                            .setBarType(mResources.getInteger(R.integer.config_bottom2SystemBarType))
                            .setZOrder(
                                    mResources.getInteger(R.integer.config_bottomSystemBarZOrder))
                            .setHideForKeyboard(mResources.getBoolean(
                                    R.bool.config_hideBottomSystemBarForKeyboard))
                            .build();
            mSystemBarConfigMap.put(BOTTOM2, bottom2BarConfig);
        }
    }
    ...
    private Map<@SystemBarSide Integer, Boolean> getSystemBarsVisibilityOnInit() {
        ...
        visibilityMap.put(BOTTOM2, mBottom2NavBarEnabled);
    ...
    private static boolean isHorizontalBar(@SystemBarSide int side) {
        return side == TOP || side == BOTTOM || side == BOTTOM2;
    }
