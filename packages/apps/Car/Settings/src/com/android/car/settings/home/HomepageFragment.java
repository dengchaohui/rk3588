...
public class HomepageFragment extends SettingsFragment {
    ...
    protected int getPreferenceScreenResId() {
        Display mCurrentDisplay = getContext().getDisplay();
        Log.d("HomepageFragment", "display = " + mCurrentDisplay);
        return mCurrentDisplay.getDisplayId() != 0 ? R.xml.homepage_fragment_no_manager : R.xml.homepage_fragment;
    }
