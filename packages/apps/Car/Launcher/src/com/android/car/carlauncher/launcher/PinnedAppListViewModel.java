    ...
    public void loadData() {
        ...
        new AsyncTask<Void, Void, List<AppEntry>>() {
            ...
            protected List<AppEntry> doInBackground(Void... voids) {
                ...
                final Set<String> pinnedAppsComponents = sp.getStringSet(mUserId + "-" + PINNED_APPS_KEY, null);
                ...
                for (String componentString : pinnedAppsComponents) {
                    ...
                    if (mUserId > 0) {
                        apps = mPackageManager.queryIntentActivitiesAsUser(mainIntent,
                                PackageManager.GET_META_DATA, mUserId);
                    } else {
                        apps = mPackageManager.queryIntentActivities(mainIntent,
                    ...
                    if (apps != null) {
                        ...
                        Log.d("PinnedAppListViewModel", "userId = " + mUserId + ", app == null");
                    }
                }
