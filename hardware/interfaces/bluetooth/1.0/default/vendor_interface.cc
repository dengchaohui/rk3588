...
static const char* VENDOR_NFORETEK_LIBRARY_NAME = "libbt-vendor-nforetek.so";
...
bool VendorInterface::Open(InitializeCompleteCallback initialize_complete_cb,
  ...
  } else if(0 == strncmp(wifi_type, "NF3205PQ", 8)) {
	strcpy(vendor_lib_name, VENDOR_NFORETEK_LIBRARY_NAME);
  } else if
	((0 == strncmp(wifi_type, "RTL", 3)) ||
