...
#ifndef ANDROID_EXTERNAL_CAMERA360_GRALLOC4
#define ANDROID_EXTERNAL_CAMERA360_GRALLOC4
...
typedef struct cam_mem_ops_s {
    ...
    //alloc
    cam_mem_info_t* (*alloc)(cam_mem_handle_t* handle,size_t size, unsigned int halPixlformat,
