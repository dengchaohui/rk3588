...
#endif
	printk("\n");
	printk("==== Launching Wi-Fi driver! (Powered by TOPEET) ====\n");
	printk("=======================================================\n");
	printk("Realtek 8723DU USB WiFi driver (Powered by TOPEET,Ver %s) init. \n", DRIVERVERSION);
...
#endif
	printk("\n");
	printk("==== Dislaunching Wi-Fi driver! (Powered by TOPEET) ====\n");
	printk("=======================================================\n");
	printk("Realtek 8723DU USB WiFi driver (Powered by TOPEET,Ver %s) init. \n", DRIVERVERSION);
	rtw_drv_halt();
